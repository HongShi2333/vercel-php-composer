...
//定义颜色的值为红色
$blue = ImageColorAllocate($im, 30,232,255);
//加载字体
$font = 'msyh.ttf';
//输出
imagettftext($im, 15, 0, 30, 40, $black, $font,'欢迎您,来自 Linux.do 的朋友');
imagettftext($im, 15, 0, 30, 80, $black, $font, '今天是'.date('Y年n月j日').' 星期'.$weekarray[date("w")]);
//当前时间添加到图片
imagettftext($im, 15, 0, 30, 120, $black, $font,'您的IP是:'.$ip.'');
//ip
imagettftext($im, 15, 0, 30, 160, $black, $font,'您使用的是'.$os.'操作系统');
imagettftext($im, 13, 0, 30, 190, $black, $font,'Powerd by PHP-7.2');
ImageGif($im);
ImageDestroy($im);
